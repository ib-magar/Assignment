...
public class TrajectoryVisualizer : MonoBehaviour
{
    ...
    private void Start()
    {
        trajectoryLineRenderer.positionCount = 1;
    ...
    void Update()
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(transform.position, (mousePosition - (Vector2)transform.position).normalized, Vector2.Distance(transform.position,mousePosition),reflectionLayerMask);
